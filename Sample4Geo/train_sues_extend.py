...
from sample4geo.dataset.sues_extend import SUESDatasetEval

# from sample4geo.dataset.university import U1652DatasetEval, U1652DatasetTrain, get_transforms
from sample4geo.dataset.sues_extend import SUESEDatasetTrain, SUESDatasetEval, get_transforms
