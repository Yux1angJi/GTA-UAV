...
python train_gta.py --train_pairs_meta_file "same-area-drone2sate-train.json" --test_pairs_meta_file "same-area-drone2sate-test.json" --log_to_file --log_path "nohup_train_gta_pos_semipos_same_bs40_e5_s0.1k5_vit.out" --train_mode 'pos_semipos' --test_mode 'pos' --gpu_ids 0,1 --label_smoothing 0.1 --with_weight --k 5 --epoch 5 --model 'vit_base_patch16_rope_reg1_gap_256.sbb_in1k' --lr 0.0001 --batch_size 40
python train_gta.py --train_pairs_meta_file "cross-area-drone2sate-train.json" --test_pairs_meta_file "cross-area-drone2sate-test.json" --log_to_file --log_path "nohup_train_gta_pos_semipos_cross_bs40_e5_s0.1k5_vit.out" --train_mode 'pos_semipos' --test_mode 'pos' --gpu_ids 0,1 --label_smoothing 0.1 --with_weight --k 5 --epoch 5 --model 'vit_base_patch16_rope_reg1_gap_256.sbb_in1k' --lr 0.0001 --batch_size 40

python train_gta.py --train_pairs_meta_file "same-area-drone2sate-train.json" --test_pairs_meta_file "same-area-drone2sate-test.json" --log_to_file --log_path "nohup_train_gta_pos_semipos_same_bs40_e5_s0.1k5_dinov2vit.out" --train_mode 'pos_semipos' --test_mode 'pos' --gpu_ids 0,1 --label_smoothing 0.1 --with_weight --k 5 --epoch 5 --model 'vit_base_patch14_reg4_dinov2.lvd142m' --lr 0.0001 --batch_size 40
python train_gta.py --train_pairs_meta_file "cross-area-drone2sate-train.json" --test_pairs_meta_file "cross-area-drone2sate-test.json" --log_to_file --log_path "nohup_train_gta_pos_semipos_cross_bs40_e5_s0.1k5_dinov2vit.out" --train_mode 'pos_semipos' --test_mode 'pos' --gpu_ids 0,1 --label_smoothing 0.1 --with_weight --k 5 --epoch 5 --model 'vit_base_patch14_reg4_dinov2.lvd142m' --lr 0.0001 --batch_size 40

# python train_gta.py --data_dir "randcam2_5area/same_h123456_z4567" --log_to_file --log_path "nohup_train_gta_h123456_z456_same_lc_bs40_e10_s0.1_valiou_vit.out" --train_mode 'semi_iou' --test_mode 'iou' --gpu_ids 0,1 --label_smoothing 0.1 --epoch 10 --model 'vit_base_patch16_rope_reg1_gap_256.sbb_in1k' --lr 0.0001 --batch_size 40
